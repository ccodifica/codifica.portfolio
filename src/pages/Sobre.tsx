...
const Sobre = () => {
  ...
  const values = [
    {
      title: "Inovação",
      description: "Utilizamos as tecnologias mais modernas para criar soluções que fazem a diferença no mercado."
    },
    {
      title: "Qualidade",
      description: "Cada linha de código é cuidadosamente pensada para entregar o melhor resultado possível."
    },
    {
      title: "Parceria",
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold font-manrope mb-6 text-balance leading-tight">
              Sobre a
              <span className="text-primary"> Codifica</span>
            </h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-primary">Quem Somos</h3>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Somos uma equipe apaixonada por tecnologia e inovação, com anos de 
                experiência no desenvolvimento de soluções digitais para empresas 
                de todos os portes. Nossa expertise abrange desde aplicações web 
                modernas até sistemas complexos de gestão empresarial.
              </p>
            ...
            <div className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-2xl p-8 border border-border/50">
              <h4 className="text-xl font-semibold mb-4">Tecnologias que dominamos:</h4>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              ...
              a alcançar o próximo nível através da tecnologia.
            </p>
